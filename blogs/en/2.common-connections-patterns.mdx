...
**Examples:**
- Add "S" to get a new word: CARE鈫扖ARES, MILE鈫扢ILES
- Words that rhyme with numbers: ATE (8), FINE (9), HEAVEN (7)

**How to spot it:** The hardest to identify. If nothing else seems to work, try manipulating the words 鈥?adding letters, removing letters, or saying them aloud.
